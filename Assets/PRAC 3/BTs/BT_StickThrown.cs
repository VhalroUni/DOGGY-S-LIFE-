...
[CreateAssetMenu(fileName = "BT_StickThrown", menuName = "Behaviour Trees/BT_StickThrown", order = 1)]
public class BT_StickThrown : BehaviourTree
{
    ...
    public override void OnConstruction()
    {
      ...
      */
        ...
        DynamicSelector stick = new DynamicSelector();

        stick.AddChild(new CONDITION_InstanceNear("1000", "STICK", "true", "TheStick"),
            new BT_ChaseStick()
        );

        stick.AddChild(new CONDITION_AlwaysTrue(),
            new BT_RelaxedWalk()
        );
